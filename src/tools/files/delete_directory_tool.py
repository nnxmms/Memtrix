...
BLOCKED_DIRS: set[str] = {"attachments", "downloads"}
...
class DeleteDirectoryTool(BaseTool):
    ...
    def __init__(self, workspace_dir: str) -> None:
        ...
        super().__init__(
            ...
            description="Delete a directory and all its contents from the workspace. Cannot delete protected directories (attachments/, downloads/). WARNING: this action cannot be reverted.",
            parameters={
                "type": "object",
                "properties": {
                    "path": {
